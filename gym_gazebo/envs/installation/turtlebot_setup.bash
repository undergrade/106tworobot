...
if [ -z "$GYM_GAZEBO_WORLD_456" ]; then
  bash -c 'echo "export GYM_GAZEBO_WORLD_456="`pwd`/../assets/worlds/456.world >> ~/.bashrc'
else
  bash -c 'sed "s,GYM_GAZEBO_WORLD_456=[^;]*,'GYM_GAZEBO_WORLD_456=`pwd`/../assets/worlds/456.world'," -i ~/.bashrc'
fi
if [ -z "$GYM_GAZEBO_WORLD_ROOM1" ]; then
  bash -c 'echo "export GYM_GAZEBO_WORLD_ROOM1="`pwd`/../assets/worlds/room1.world >> ~/.bashrc'
else
  bash -c 'sed "s,GYM_GAZEBO_WORLD_ROOM1=[^;]*,'GYM_GAZEBO_WORLD_ROOM1=`pwd`/../assets/worlds/room1.world'," -i ~/.bashrc'
fi
